import WeeksleepChart from "../Charts/WeeksleepChart";
        ...
        <div className=" inset-0 z-40 flex flex-col items-start border-2 border-[#ffffff] shadow-xl bg-[#f9f9f9] px-2 mt-3">
          <div className="flex flex-col items-start">
            ...
            <p className="text-md mt-2 px-2 py-2">
              ...
              immune system and speeds up ageing. Do not strain yourself too
              much, keep good mood,makke reasonable arrangements for work and
              rest time and do more exercise to keep fit.
            </p>
          </div>
          ...
          <div className="flex flex-col items-start mt-2 px-2 py-2 ">
            ...
            <p className="text-md mt-2 mb-4 text-pretty ">
              ...
              records your sleep condition on devices such as watches and
              analyses quality to help you adjust your sleep habits.
            </p>
          </div>
        </div>
      </div>
